...
<body class="<?php echo themeClass($theme); ?>">
    <div class="layout">
        <?php renderSidebar('categorias'); ?>
        <main class="content">
            <div class="page-header">
                <div class="page-title">
                    <p class="eyebrow">Cadastro</p>
                    <h1>Categorias</h1>
                    <span class="text-muted">Gerencie categorias de despesas</span>
                </div>
                <div class="actions no-print d-flex gap-2 flex-wrap">
            ...
            <div class="panel">
                ...
                <form method="post" class="form-grid" autocomplete="off">
                    ...
                    <div>
                        <button type="submit" class="button button-primary w-100">Adicionar</button>
                    </div>
                </form>
            </div>
